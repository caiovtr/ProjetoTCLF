...
Route::get('/campeonato/edit/{id}', [App\Http\Controllers\ControllerCampeonato::class, 'edit'])->name('editarCampeonato');
...
Route::get('/time/edit/{id}', [App\Http\Controllers\ControllerTime::class, 'edit'])->name('editarTime');
...
Route::get('/jogador/edit/{id}', [App\Http\Controllers\ControllerJogador::class, 'edit'])->name('editarJogador');
...
Route::get('/timescampeonato/{id}', [App\Http\Controllers\ControllerTimeCampeonato::class, 'create'])->name('novoTimeCampeonato');
Route::post('/timescampeonato', [App\Http\Controllers\ControllerTimeCampeonato::class, 'store'])->name('gravaNovoTimeCampeonato');
Route::get('/timescampeonato/apagar/{idC}/{idT}', [App\Http\Controllers\ControllerTimeCampeonato::class, 'destroy'])->name('deletaTimeCampeonato');